...
(function(){
  ...
  style.textContent = `
    ...
    @keyframes sstPop {
      0%   { box-shadow: 0 0 0 0   rgba(113,255,0,0.28); }
      60%  { box-shadow: 0 0 0 9px  rgba(113,255,0,0); }
