...
module.exports = {
  ...
  steps: [
    { name: 'Seed probe product at stock 10', async run(ctx) {
    ...
    { name: 'Place order for qty 2 (decrement path)', async run(ctx) {
    ...
    { name: 'Stock is now 8', async run(ctx) {
    ...
    { name: 'Search + seller view agree on 8', async run(ctx) {
    ...
    { name: 'Realtime + offline cache reflect change', async run() {
