...
module.exports = {
  ...
  steps: [
    { name: 'Seed seller identity (+ premium claim)', capability: 'Seller authentication', async run(ctx) {
    ...
    { name: 'Edit product (price change persists)', capability: 'Product mutation', async run(ctx) {
        const p = ctx.dataset.PRODUCTS[0];
